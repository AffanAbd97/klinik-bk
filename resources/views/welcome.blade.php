...
<body>
    <header>
        <nav class="bg-green-500 border-gray-200 px-4 lg:px-6 py-2.5  dark:bg-gray-900">
            <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                <a href="/" class="flex items-center">
                    <img src="{{ asset('icons/logo.svg') }}" class="mr-3 h-6 sm:h-9" alt="Flowbite Logo" />
    ...
    <section class="bg-green-500 dark:bg-gray-900 flex items-center justify-center h-[70vh]">
        <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12 ">

            <h1
                class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white">
                Sistem Temu Janji Pasien Dokter</h1>
            <p class="mb-8 text-lg font-normal text-white lg:text-xl sm:px-16 xl:px-48 dark:text-gray-400">Here at
                Bengkel Koding Udinus - Web Developer</p>
    ...
    <section class="bg-white dark:bg-gray-950">
        <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
            <div class="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
                <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">Mulai Aktivitas</h2>
                <p class="mb-5 font-light text-gray-500 sm:text-xl dark:text-gray-400">Masuk Sesuai Dengan Kebutuhan Anda Disin</p>
            </div>
            <div class="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">
                ...
                <div
                    ...
                    <div>
                        ...
                        <h3 class="mb-4 text-2xl font-semibold mt-8">Pasien</h3>
                        <p class="font-light text-gray-500 sm:text-lg dark:text-gray-400 mb-6">Apabila Anda seorang
                            Pasien, Silahkan Login Untuk memulai pemesanan</p>
                        <!-- List -->
                        <ul role="list" class="mb-8 space-y-4 text-left ">
                            <li class="flex items-center space-x-3">
                                ...
                                <span>Melakukan Pemesanan Jadwal Periksa</span>
                            </li>
                            <li class="flex items-center space-x-3">
                                <!-- Icon -->
                                <svg class="flex-shrink-0 w-5 h-5 text-green-500 dark:text-green-400"
                    ...
                    <a href="{{ route('login.pasien') }}"
                        class="align-bottom text-white bg-green-600 hover:bg-green-700 focus:ring-4 focus:ring-green-200 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:text-white  dark:focus:ring-green-900">Masuk
                        Disini</a>
                </div>
                {{-- Dokter --}}
                <div
                  ...
                  <div>
                    ...
                    <ul role="list" class="mb-8 space-y-4 text-left align-bottom">
                        <li class="flex items-center space-x-3">
                            ...
                            <span>Mengelola Data Pasien</span>
                        </li>
                        <li class="flex items-center space-x-3">
                            <!-- Icon -->
                            <svg class="flex-shrink-0 w-5 h-5 text-green-500 dark:text-green-400" fill="currentColor"
                            ...
                            <span>Mengelola Data Dokter</span>
                        </li>
    ...
    <footer class="p-4 bg-green-500 sm:p-6 dark:bg-gray-800">
        <div class="mx-auto max-w-screen-xl">
            <div class="md:flex md:justify-between">
                <div class="mb-6 md:mb-0">
                    <a href="https://flowbite.com" class="flex items-center">
                        <img src="{{ asset('icons/logo.svg') }}" class="mr-3 h-8" alt="FlowBite Logo" />
                        <span class="self-center text-2xl font-semibold whitespace-nowrap text-white">Poliklinik</span>
                    </a>
                </div>
            ...
            <div class="sm:flex sm:items-center sm:justify-between">
                <span class="text-sm text-white sm:text-center dark:text-gray-400">© 2023 <a href="/"
                        class="hover:underline">Affan Abdullah Izzuddin</a>. All Rights Reserved.
                </span>
