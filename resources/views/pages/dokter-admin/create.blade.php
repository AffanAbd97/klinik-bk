                ...
                <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                    <div class="sm:col-span-2">
                        ...
                        <input type="text" name="nama" id="nama" value="{{ old('nama') }}"
                            class="bg-gray-50 border {{ $errors->has('nama') ? 'border-red-600' : 'border-gray-300' }}  text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5"
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <input type="text" name="no_hp" id="no_hp" value="{{ old('no_hp') }}"
                            class="bg-gray-50 border {{ $errors->has('no_hp') ? 'border-red-600' : 'border-gray-300' }}  text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5"
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <textarea id="alamat" rows="4" name="alamat"
                                class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border {{ $errors->has('alamat') ? 'border-red-600' : 'border-gray-300' }} focus:ring-blue-500 focus:border-blue-500 "
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <input type="email" name="email" id="email" value="{{ old('email') }}"
                                class="bg-gray-50 border {{ $errors->has('email') ? 'border-red-600' : 'border-gray-300' }}  text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5"
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <input type="password" name="password" id="password" value="{{ old('password') }}"
                                class="bg-gray-50 border {{ $errors->has('password') ? 'border-red-600' : 'border-gray-300' }}  text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5"
