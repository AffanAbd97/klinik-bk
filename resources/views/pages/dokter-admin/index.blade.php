...
@section('content')
    <section class="md:flex grid grid-cols-1 justify-between items-center mb-8 gap-4">
        <div>
            <h1 class="font-semibold text-2xl">Data Poli</h1>
        ...
        <a href="{{route('dokter.create')}}"
            class="text-center text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-semibold rounded-lg text-sm px-10 py-5 focus:outline-none">Tambah
            Data</a>
    </section>

    @livewire('dokter-list')
@endsection
