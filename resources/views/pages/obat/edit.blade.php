...
<section class="md:flex grid grid-cols-1 justify-between items-center mb-8 gap-4">
    <div>
        <h1 class="font-semibold text-2xl dark:text-white">Edit Obat</h1>
            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-2">
                ...
                <li aria-current="page">
                    <div class="flex items-center">
                        ...
                        <span class="ms-1 text-lg font-medium text-gray-500 md:ms-2 dark:text-gray-400">Edit Obat</span>
                    </div>
                </li>
            </ol>
        </nav>
            ...
            <form action="{{route('obat.update',['obat'=>$obat])}}" method="POST">
                ...
                <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                    ...
                    <div class="w-full">
                        ...
                        <input type="text" name="kemasan" id="kemasan" value="{{old('kemasan')??$obat->kemasan}}" class="bg-gray-50 border {{$errors->has('kemasan') ? 'border-red-600' : 'border-gray-300' }}   text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Kemasan Obat" >
                        @error('kemasan')
                        <p id="outlined_error_help" class="mt-2 text-xs text-red-600">{{$message}}</p> 
                        @enderror
