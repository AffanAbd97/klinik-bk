            ...
            <form action="{{route('obat.store')}}" method="POST">
                ...
                <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                    ...
                    <div class="w-full">
                        ...
                        <input type="text" name="kemasan" id="kemasan" value="{{old('kemasan')}}" class="bg-gray-50 border {{$errors->has('kemasan') ? 'border-red-600' : 'border-gray-300' }}   text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5" placeholder="Kemasan Obat" >
                        @error('kemasan')
                        <p id="outlined_error_help" class="mt-2 text-xs text-red-600">{{$message}}</p> 
                        @enderror
                    ...
                    <div class="w-full">
                        ...
                        <input type="number" value="{{old('harga')}}" name="harga" id="harga" class="bg-gray-50 border {{$errors->has('harga') ? 'border-red-600' : 'border-gray-300' }}  text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5" placeholder="Harga Obat" >
                        @error('harga')
                        <p id="outlined_error_help" class="mt-2 text-xs text-red-600">{{$message}}</p> 
                        @enderror
