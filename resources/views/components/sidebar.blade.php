<aside
    ...
    <div class="overflow-y-auto py-5 px-3 h-full bg-white dark:bg-gray-800 dark:border-gray-700">
        ...
        <ul class="space-y-2">
            ...
            <li>
                <a href={{ $route }}
                    class=" {{ menuActive(['home']) }} flex items-center p-2  text-base font-medium text-gray-900 rounded-lg  hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 group">
            ...
            @elseif (session('authenticate') && session('authenticate')->peran == 'Dokter')
                <li>
                    <a href="{{ route('pasien') }}"
                        class=" {{ menuActive(['pasien']) }} flex items-center p-2 justify-between text-base font-medium text-gray-900 rounded-lg  hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 group">
                        <i
                            class="fa-solid  fa-hospital text-2xl text-gray-500 transition duration-75 dark:text-gray-400 dark:group-hover:text-white group-hover:text-gray-900 "></i>
