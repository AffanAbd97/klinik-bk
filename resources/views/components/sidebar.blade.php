            ...
            <ul id="dropdown-obat" class="hidden py-2 space-y-2 transition-transform duration-100">
                <li>
                    <a href={{route('obat.index')}} 
                        class="{{subMenuActive(['obat.index'])}} flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100  ">Tabel Obat</a>
                </li>
                <li>
                    <a href={{route('obat.create')}}
                        class=" {{subMenuActive(['obat.create'])}} flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100  ">Tambah Obat</a>
                </li>
            ...
            <ul id="dropdown-poli" class="hidden py-2 space-y-2 transition-transform duration-100">
                <li>
                    <a href={{route('poli.index')}} 
                        class="{{subMenuActive(['poli.index'])}} flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100  ">Tabel Poli</a>
                </li>
                <li>
                    <a href={{route('poli.create')}}
                        class=" {{subMenuActive(['poli.create'])}} flex items-center p-2 pl-11 w-full text-base font-medium text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100  ">Tambah Poli</a>
                </li>
