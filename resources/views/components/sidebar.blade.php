<div id="sideBar"
class=" flex flex-col flex-wrap bg-white border-r border-gray-300 p-6 flex-none w-64 md:-ml-64 fixed top-16 md:z-30 h-screen md:shadow-xl animated faster">
