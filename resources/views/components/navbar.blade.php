<nav class="bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700  px-4 py-4  fixed left-0 right-0 top-0 z-[45] h-16">
    <div class="flex flex-wrap justify-between items-center">
        ...
        <div class="flex items-center lg:order-2">
            ...
            <div class="hidden z-50 my-4 w-56 text-base list-none bg-white rounded divide-y divide-gray-100 shadow  rounded-xl"
                ...
                <div class="py-3 px-4">
                    <span
                        class="block text-sm font-semibold text-gray-900 ">{{ session()->get('authenticate')->nama }}</span>
                    <span
                        class="block text-sm text-gray-900 truncate ">{{ session()->get('authenticate')->email }}</span>
                </div>


                <ul class="py-1 text-gray-700 " aria-labelledby="dropdown">
                    <li>
                        <a href="{{ route('logout') }}" class="block py-2 px-4 text-sm hover:bg-gray-100 e">Sign
                            out</a>
                    </li>
                </ul>
            </div>
