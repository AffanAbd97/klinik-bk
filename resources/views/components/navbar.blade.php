<div
class="md:fixed sticky md:w-full top-0 z-20 flex flex-row flex-wrap items-center bg-white p-6 border-b border-gray-300 h-26">

<!-- logo -->
<div class="flex-none w-56 flex flex-row items-center">
    <button id="sliderBtn" class="flex-none text-left text-gray-900 hidden md:block mr-2 h-5 w-5">
