        ...
        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                <tr>
                    ...
                    <th scope="col" class="px-4 py-3">No Rekam Medis</th>
                    <th scope="col" class="px-4 py-3"></th>
            ...
            <tbody>
                @forelse ($pasien as $item)
                    <tr class="border-b dark:bg-gray-800 dark:border-gray-700">
                        ...
                        <td class="px-4 py-3">{{ $item->no_ktp }}</td>
                        ...
                        <td class="px-4 py-3 flex items-center">
                            ...
                            <div id="action-menu-{{ $loop->index }}"
                                ...
                                <ul class="py-2 text-sm text-gray-700 dark:text-gray-200"
                                    ...
                                    <li>
                                        <a href="{{route('pasien.edit',['pasien'=>$item])}}"
                                ...
                                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                    ...
                                    <div class="p-4 md:p-5 text-center">
                                        ...
                                        <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Apa Anda Yakin Ingin Menghapus
                                            Data ini?</h3>
                                        <form action={{ route('pasien.delete', ['pasien' => $item]) }} method="POST">
                                            @csrf
                                            @method('delete')
...
@empty
    <tr class="border-b dark:bg-gray-800 dark:border-gray-700">
        <th scope="row" colspan="7"
            class="px-4 py-3 font-medium text-xl text-gray-900 dark:text-white whitespace-nowrap text-center">Data
            Tidak
            Ditemukan</th>
