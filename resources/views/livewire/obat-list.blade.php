            ...
            <tbody>
                @forelse ($obat as $item)
                    <tr class="border-b dark:bg-gray-800 dark:border-gray-700 ">
                        ...
                        <td class="px-4 py-3">{{ format_rupiah($item->harga) }}</td>
                        ...
                        <td class="px-4 py-3 flex items-center justify-end">
                            ...
                            <div id="action-menu-{{ $loop->index }}"
                                ...
                                <ul class="py-2 text-sm text-gray-700 dark:text-gray-200"
                                    ...
                                    <li>
                                        <a href="{{ route('obat.edit', ['obat' => $item]) }}"
...
@empty
    <tr class="border-b dark:bg-gray-800 dark:border-gray-700">
        <th scope="row"
            class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap text-center dark:text-white  text-xl"
            colspan="5">Data Tidak
            Ditemukan</th>
